...
$bundle_router->addController(new Controller('starpass', '#^/' . ROOT . $bundle_translator->getTranslation($blanguage, 'URL_STORE') . '/' . $bundle_translator->getTranslation($blanguage, 'URL_BUY') . '/' . 'starpass/?#', $bundle_translator->getTranslation($blanguage, 'URL_STORE') . '/' . $bundle_translator->getTranslation($blanguage, 'URL_BUY') . '/' . 'starpass', 'store'));
$bundle_router->addController(new Controller('allopass', '#^/' . ROOT . $bundle_translator->getTranslation($blanguage, 'URL_STORE') . '/' . $bundle_translator->getTranslation($blanguage, 'URL_BUY') . '/' . 'allopass/?#', $bundle_translator->getTranslation($blanguage, 'URL_STORE') . '/' . $bundle_translator->getTranslation($blanguage, 'URL_BUY') . '/' . 'allopass', 'store'));
$bundle_router->addController(new Controller('paypal', '#^/' . ROOT . $bundle_translator->getTranslation($blanguage, 'URL_STORE') . '/' . $bundle_translator->getTranslation($blanguage, 'URL_BUY') . '/' . 'paypal/?#', $bundle_translator->getTranslation($blanguage, 'URL_STORE') . '/' . $bundle_translator->getTranslation($blanguage, 'URL_BUY') . '/' . 'paypal', 'store'));
